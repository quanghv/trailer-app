...
export default {
  ...
  // Color
  brandPrimary: config.colors.brandPrimary,
  brandInfo: config.colors.brandInfo,
  brandSuccess: "#5cb85c",
  brandDanger: "#d9534f",
  brandWarning: "#f0ad4e",
  brandSidebar: "#252932",
  ...
  // Footer
  footerHeight: 55,
  footerDefaultBg: config.colors.brandPrimary,
  ...
  // Header
  toolbarBtnColor: "#fff",
  toolbarDefaultBg: config.colors.brandPrimary,
  ...
  // Spinner
  defaultSpinnerColor: config.colors.brandPrimary,
