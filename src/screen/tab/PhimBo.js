...
export default class PhimBo extends React.Component {
  static navigationOptions = {
    header: props => <AppHeader title={config.strings.phimBo} {...props} />
  };
  state = {
    data: undefined
  };
  ...
  _getData = () => {
    getFromServer(actions.urlMovieList, { type: "phimbo" }).then(json => {
