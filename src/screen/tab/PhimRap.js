...
export default class PhimRap extends React.Component {
  static navigationOptions = {
    header: props => (
      <AppHeader title={config.strings.phimChieuRap} {...props} />
    )
  };
  state = {
    data: undefined
  ...
  _getData = () => {
    getFromServer(actions.urlMovieList, { type: "phimchieurap" }).then(json => {
